class Game1
  #Player is the code breaker, computer is the code maker. 
  #To fix: When code has repeated numbers, hints should note 
  require_relative 'comp_codemaker.rb'
  require_relative 'player_codebreaker.rb'
  require 'colorize'

  def initialize
    puts "Your mission: Deduce the 4 digit code generated by the machine."
    puts "Good luck! You have 12 tries to get the code right."
    puts "Type in your 4-digit guess for this round."
    @maker = CompCodemaker.new
    @breaker = PlayerCodebreaker.new(gets.chomp)
  ...
  def check_placement(code, guess)
    ...
    if guess != code
      ...
      @breaker.validation(@breaker.guess)
      @correct_place_counter = 0
      @wrong_place_counter = 0
    end
  end
